...
router.get("/me", auth_middleware_1.authMiddleware, (req, res, next) => {
    var _a, _b;
    console.log("Middleware ejecutado, nombre extraído:", (_a = req.user) === null || _a === void 0 ? void 0 : _a.name); // Log para verificar
    req.params.name = (_b = req.user) === null || _b === void 0 ? void 0 : _b.name;
    next();
